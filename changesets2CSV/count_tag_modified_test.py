...
HARDCODED_QUERY_RESULT = {
  ...
  "osm3s": {
    "timestamp_osm_base": "2019-08-16T21:14:02Z",
        ...
        for set in objects_by_changeset:
            ...
            for tag in objects_by_tag:
                ...
                for this_obj in objects_by_tag[tag]:
                    #print(type(old_objects_by_changeset[set][tag]))
                    ...
                    '''
                    old_objects_by_changeset[set][tag].append(this_obj)
                    '''
                    #print(this_obj)
        ...
        for this_changeset in old_objects_by_changeset:
            ...
            for this_tag in old_objects_by_changeset[this_changeset]:
                ...
                for this_obj in old_objects_by_changeset[this_changeset][this_tag]:
                    ...
                    print('Old: ', old_obj)
                    print(this_tag_to_check,": ", old_val)
                    print('New: ', new_obj)
                    print(this_tag_to_check,": ", new_val)

                    if old_val != new_val:
                        print(old_val," is not ", new_val)
                        differences_counted += 1
